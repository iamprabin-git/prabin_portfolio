...
export default function AboutSection() {
  ...
  <p className="text-lg text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">Hello! I&apos;m a passionate 
  ...
  {` with a passion for building creative, user-friendly digital experiences.`}</p>
